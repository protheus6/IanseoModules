...
if(!empty($on) AND isset($ret['MODS'])) {
	//$ret['MODS']['TargetPlan'][] = MENU_DIVIDER;
	$ret['MODS']['TargetPlan'][] = 'Target Plan';
	$ret['MODS']['TargetPlan'][] = 'Qualifications' .'|'.$CFG->ROOT_DIR.'Modules/Custom/TargetPlan/QualifsP';
        if($_SESSION['MenuFinIDo'] || $_SESSION['MenuFinTDo']) {
            $ret['MODS']['TargetPlan'][] = 'Finales' .'|'.$CFG->ROOT_DIR.'Modules/Custom/TargetPlan/FinalsP';
        }
}
